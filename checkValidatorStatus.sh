...
unixtime=`date +%s`;
echo
echo "$unixtime $epochNumber $epochProgress $slotsScheduled $slotsBuilt $slotsSkipped $slotsRemaining $balanceValidator $balanceVoteAccount" >> $logPath/balances.log
date
echo
